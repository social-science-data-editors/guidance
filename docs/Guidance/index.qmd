---
layout: withtoc
title: Start here if you are an author
aliases:
  - /Guidance/Requested_information.html
...
Generically, journal's data and code availability policies **require** that
...
Some journals may require additional elements:

- a **README** in a specific format. 
- programs that create the analysis data ("**cleaning programs**")


#### Suggestions

We **strongly suggest** using some best-practices as suggested by the literature cited earlier:
...
- a clearly defined sequence of processing (possibly through a master controller script)
- citation of released code
- citation of data in the README (in addition to citing it in the article itself)

This website provides some practical guidance.

> We strongly suggest using the [template README](https://social-science-data-editors.github.io/template_README/) available on this site.

#### Encourage

We **encourage** you

- to deposit data early in the research process, as soon as data is collected/ cleaned/ etc. This does not mean that the data becomes public at that time, only that the data has been "locked" in a specific state. See [Data and Code Hosting](#data-and-code-hosting) for some options.
...
> For more details, see [Requested information for data](Requested_information_data.qmd).
