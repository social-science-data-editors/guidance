...
description: "Sometimes, it is worthwhile to separately deposit the data that is created as part of a broader research project, rather than include it in a single replication package. This document walks you through that."
categories: [deposits, preservation, DOI, data, big data]
aliases: 
  - /sample-depositing-data-for-greater-good.html
---
