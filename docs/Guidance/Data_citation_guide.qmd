...
aliases:
  - /Data_citation_guide.html
  - /Data_citation_guidance.html
categories: [citations, data citation, data]
...
It has been long-standing convention in economics to cite a paper describing the data, but not the data themselves. This is inconsistent with other citation practices, in addition to not being compliant with the Data Citation Principles. In principle, it is simple:

> If you use the data, you cite the data. If you reference the document, you cite the document. But you don't cite the document when using the data.

It is worthwhile to point out that we don't cite the book **review** when wanting to reference what an author said in a **book**. We cite the book directly. This is the literature analog to data citations.
...
- [Additional guidance on Data Citations](addtl-data-citation-guidance.qmd).
