...
- Use **in-text citation**, that is, a short pointer, usually author and year, e.g. (BEA, 2016), linking to that reference entry.

Publishers usually have specific requirements about each element's format (while they are usually enforced for the published manuscript, you may have some more flexibility in the README).
