...
description: "Sample Stata configuration, including how to install packages persistently."
---
...
/* It will not overwrite existing packages!       */

include "config.do"
cap ssc install package1
cap ssc install package2
cap ssc install package3
```
