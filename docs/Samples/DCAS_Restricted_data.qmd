...
description: "Examples of data availability statements. Often, the only restriction is a requirement to not redistribute, and to cite."
---
...
We maintain a database of different Terms Of Use accessible at [this link](https://social-science-data-editors.github.io/reference/TermsOfUse.html).
...
Adapted from [Fort (2016)](https://doi.org/10.1093/restud/rdw057), Supplementary data (see also the [Sample RADC statement](../Samples/samples/sample_radc_statement2.md ))
