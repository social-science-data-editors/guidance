...
description: "Sample R configuration, including how to install packages persistently."
---
...
- using the [`packrat` package](https://rstudio.github.io/packrat/)
- using [`containerit` package](https://o2r.info/containerit/)
- using [`renv` package](https://rstudio.github.io/renv/index.html) 
...
```
remotes::install_version("rdrobust", version = "2023.10.1", lib=libpath)
remotes::install_version("rddensity", version = "2023.10.1", lib=libpath)
remotes::install_version("gridExtra", version = "2.3", lib=libpath)
```
